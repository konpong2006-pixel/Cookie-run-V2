...
class CookieBot:
    ...
    def _is_relay_enabled(self):
        if isinstance(self.use_relay, str):
    ...
    def _try_use_relay(self, controller, vision, img, relay_used):
        ...
        if not vision.is_relay_window(img, RELAY_SCAN_AREA):
            return False
                ...
                try:
                    ...
                    if self.current_state == "LOBBY":
                        ...
                        while self.running:
                            ...
                            if self._try_use_relay(controller, vision, img, relay_used):
                                relay_used = True
                                static_frames = 0
                                last_motion_thumb = None
                                time.sleep(2)
